...
plot((two_days_df$global_active_power)/500, type = "l", ylab = "Global Active Power (kilowatts)", xlab = " ", xaxt = "n")
axis(1, at = c(0,1440,2880), labels = c("Thu", "Fri", "Sat"))
plot(two_days_df$voltage, type = "l", ylab = "Voltage", xlab = "datetime", xaxt = "n")
axis(1, at = c(0,1440,2880), labels = c("Thu", "Fri", "Sat"))
...
plot(two_days_df$global_reactive_power/(max(two_days_df$global_reactive_power)/.5), type = "l", ylab = "Global_reactive_power", xlab = "datetime", xaxt = "n")
axis(1, at = c(0,1440,2880), labels = c("Thu", "Fri", "Sat"))
